<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoPrestamosModalPag.aspx.cs" Inherits="BibliotkApp.ListadoPrestamosModalPag" %>
									        ...
									        <div class="col-md-12">
                                                  <div class="form-group">
                                                     <div class="col-xs-12"> 
                                                            <div class="card">
                                                                    <div class="card-body">
                                                                        <iframe id="myiframe" runat="server" style="height: 400px; width: 350px;" ></iframe> 
                                                                    </div>
                                                            </div>
