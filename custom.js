...
function OnClientClicked(sender, args) {
    var btn = sender;
    if (!btn.get_autoPostBack()) {
        let btnID = sender.get_id();
        btnID = btnID.substring(btnID.lastIndexOf("_") + 1);
        let lbl = $('span[id$="RadLabel1"]');
        lbl.html("Action <b>Confirmed</b>, <i>ClientClicked</i> event raised by <b>" + btnID + "</b>.")
    }
}
